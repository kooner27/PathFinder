...
def main():
    ...
    for i in range(0, len(start_states)):   
        ...
        cost, expanded_astar = dijkstra_algo.dijkstra(start, goal, gridded_map) # Replace None, None with a call to your implementation of A*
        ...
        cost, expanded_mm = mm.mm(start, goal, gridded_map) # Replace None, None with a call to your implementation of MM
        ...
        cost, expanded_biastar = bibfs_algo.bibfs(start, goal, gridded_map) # Replace None, None with a call to your implementation of Bi-A*
